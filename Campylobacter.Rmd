...
#   gpa_count$test[i] <- binom.test(gpa_count$invasive[i], 10, gpa_count$gastrointestinal[i]/20)$p.value
# }
for(i in 1:nrow(gpa_count)) {
...
# gpa_count$test <- binom.test(gpa_count$invasive, 10, gpa_count$gastrointestinal/20)
